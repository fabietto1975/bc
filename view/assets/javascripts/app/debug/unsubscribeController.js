'use strict';
cpControllers.controller('unsubscribeController',
        ['$translate',
            '$scope',
            '$location',
            '$cookieStore',
            ...
            function ($translate, $scope, $location, $cookieStore, $routeParams, countries, contacts, unsubscribeInitialData) {
                ...
                unsubscribeInitialData.getData().then(function (data) {
                    ...
                    jQuery.each($scope.countries, function (index, item) {
                        if (item.country_desc === data.country.country_desc) {
                ...
                $scope.saveContact = function () {
                    ...
                    $scope.contact.unsubscribeCampaign = $routeParams.campaignId;
                    $scope.contact.unsubscribePackage = $routeParams.package;
